...
public class backgroundInventory extends AsyncTask <String, Void, String> {
    AlertDialog dialog;
    Context context;
    public Boolean login = false;

    public backgroundInventory(Context context)
    {
    ...
    protected void onPostExecute(String result) {
        ...
        if(result.contains("login successful"))
        {
          ...
          //  intent_name.setClass(context.getApplicationContext(), Customer.class);
